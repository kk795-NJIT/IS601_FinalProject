...
class TestUserUpdateSchema:
    ...
    def test_partial_update_both_fields(self):
        ...
        assert update.bio == "Loves testing"
...
class TestPasswordChangeSchema:
    """Tests for password change payload."""

    def test_password_change_valid(self):
        payload = PasswordChange(current_password="oldpassword", new_password="newpassword123")
        assert payload.current_password == "oldpassword"
        assert payload.new_password == "newpassword123"

    def test_password_change_must_differ(self):
        with pytest.raises(ValidationError):
            PasswordChange(current_password="samepassword", new_password="samepassword")
